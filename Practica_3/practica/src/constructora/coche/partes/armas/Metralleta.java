...
/**
 * Clase que modela una metralleta de un <code>Coche</code>
 */
public class Metralleta extends Armas {
	...
	public boolean equals(Object componente) {
		return (componente instanceof Metralleta)? true: false;
	}
